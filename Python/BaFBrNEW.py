...
# -*- coding: utf-8 -*-
"""
Created on Wed May 22 11:18:22 2024
...
def dedx(kinetic_energy, I, Z, A, X0, X1, a, m, C, A1, A2, A3, A4, A5):
...
for nenergies in range(np.size(x_axis)):
    y_axis_BaFBr[nenergies] = dedx(x_axis[nenergies], I_F, Z_F, A_F, X0, X1, a, m, C, A1_F, A2_F, A3_F, A4_F, A5_F) + \
                               dedx(x_axis[nenergies], I_Ba, Z_Ba, A_Ba, X0, X1, a, m, C, A1_Ba, A2_Ba, A3_Ba, A4_Ba, A5_Ba) + \
                               dedx(x_axis[nenergies], I_Br, Z_Br, A_Br, X0, X1, a, m, C, A1_Br, A2_Br, A3_Br, A4_Br, A5_Br)
